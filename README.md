...
> Existem funções e testes que foram criados anteriormente pela Trybe, os que eu criei ou modifiquei foram os que estão nos requisitos.
---

<strong>👨‍💻 O que deverá ser desenvolvido</strong>

Um **carrinho de compras** totalmente dinâmico! 🛒
- Utilizando a API do mercado livre.

E o desenvolvimento orientado a testes, o famoso TDD (Test Driven Development)!
